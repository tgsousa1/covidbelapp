...
var hospitais = $.getJSON("hospitais.geojson",function(data){
    L.geoJson(data,{
...
var policlinica =$.getJSON("policlinica.geojson",function(data){
    L.geoJson(data,{
        pointToLayer: function (feature, latlng){
...
var UPA = $.getJSON("UPA.geojson",function(data){
    L.geoJson(data,{
        pointToLayer: function (feature, latlng){
...
var UBS = $.getJSON("UBS.geojson",function(data){
    L.geoJson(data,{
        pointToLayer: function (feature, latlng){
...
var acessibilidade = $.getJSON("acessibilidade.geojson", function(acessData){
    L.geoJSON(acessData, {
        style: function(feature){
            ...
            return {color:"#999",weight:0.02, fillColor: fillColor, fillOpacity: .5};
        },
        onEachFeature:function(feature, layer){
